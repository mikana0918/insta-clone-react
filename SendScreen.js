    ...
    return (
      <View>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                <Text style={{ color: "gray", fontSize: 14, margin: 10 }}>
                  あうあうああああああああああああああああああああああああああ
                </Text>
              </View>
            </View>
          </TouchableOpacity>
        ...
        >
          ...
          >
            <View
              style={{ backgroundColor: "white", width: "20%", height: "100%" }}
            >
              <Icon name="camera" size={40} color="pink" />
            </View>
            <View
              style={{
                width: "80%",
            ...
            >
              <TouchableOpacity>
                <Input
                  ...
                  rightIcon={<Icon name="send" size={20} color="gray" />}
