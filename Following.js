    ...
    //   console.warn(this.constructor.name);  
      return (
        <View>
          ...
          centerComponent={{ text: 'フォロー中', style: { color: '#fff', fontSize:17,fontWeight:'bold' } }}
        ...
        />
         <ScrollView style={{backgroundColor:'white',width:'100%',paddingLeft:'3%',paddingRight:'1%',marginTop:5}}>
              <TouchableOpacity 
