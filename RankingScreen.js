      ...
      <View>
        ...
        >
          ...
          <TouchableOpacity
            ...
            onPress={() => {
              this.setState({ nav: "daily" });
            }}
          >
            <Text
              style={
                this.state.nav == "daily"
                  ? this.navSelectText
                  : this.navDefaultText
              }
            >
          ...
          <TouchableOpacity
            key={2}
            style={
              this.state.nav == "weekly" ? this.navSelect : this.navDefault
            }
            onPress={() => {
              this.setState({ nav: "weekly" });
            }}
          >
            <Text
              style={
                this.state.nav == "weekly"
                  ? this.navSelectText
                  : this.navDefaultText
              }
            >
          ...
          <TouchableOpacity
            key={3}
            style={
              this.state.nav == "monthly" ? this.navSelect : this.navDefault
            }
            onPress={() => {
              this.setState({ nav: "monthly" });
            }}
          >
            <Text
              style={
                this.state.nav == "monthly"
                  ? this.navSelectText
                  : this.navDefaultText
              }
            >
