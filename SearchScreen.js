        ...
        <View>
          ...
          >
            <TouchableOpacity
              key={0}
              style={
                this.state.nav == "user" ? this.navSelect : this.navDefault
              }
              onPress={() => {
            ...
            <TouchableOpacity
              key={1}
              style={
                this.state.nav == "nearby" ? this.navSelect : this.navDefault
              }
              onPress={() => {
                this.setState({ nav: "nearby" });
              }}
            >
              <Text
                style={
                  this.state.nav == "nearby"
                    ? this.navSelectText
                    : this.navDefaultText
                }
              >
            ...
            <TouchableOpacity
              key={2}
              style={
                this.state.nav == "tags" ? this.navSelect : this.navDefault
              }
              onPress={() => {
                this.setState({ nav: "tags" });
              }}
            >
              <Text
                style={
            ...
            <TouchableOpacity
              key={3}
              style={
                this.state.nav == "ranking" ? this.navSelect : this.navDefault
              }
              onPress={() => {
                this.setState({ nav: "ranking" });
              }}
            >
              <Text
                style={
                  this.state.nav == "ranking"
                    ? this.navSelectText
                    : this.navDefaultText
                }
              >
